                ...
                <nav className="w-full h-15 flex items-center  justify-between gap-3 px-4 bg-white shadow-sm">
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            <PanelTopClose
                                className="w-6 h-6 text-black transition-transform duration-300 hover:scale-125 hover:rotate-90" />
                        </button>
                    ...
                    <div className="flex items-center w-[600px] h-[13px]">
                        ...
                        <button
                            className="w-16 h-10.25 flex items-center 
                            justify-center border border-gray-300 border-l-0 
                            rounded-r-full bg-[#f1f1f1] hover:border-[#c0c3c7] hover:cursor-pointer transition"
